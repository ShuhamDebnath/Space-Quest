...
public class PhaserBullet : MonoBehaviour
{
    ...
    void Update()
    {
        transform.position += new Vector3(weapon.stats[weapon.weaponLevel].speed * Time.deltaTime, 0f, 0f);
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        if (collision.gameObject.CompareTag("Obstacle"))
        {
            ...
            if (astroid) astroid.TakeDamage(weapon.stats[weapon.weaponLevel].damage, true);
